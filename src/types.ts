...
export interface EmployeeFineSettings {
  fineEnabled: boolean;
  autoDeductionEnabled: boolean;
  gracePeriodDays: number; // 0, 1, 2, 3, 5, 7, 15, 30 days
  maxFineAmount: number;
  fiftyPercentRuleEnabled: boolean;
  fineTable?: Record<number, number>; // Missing Hours (integer) -> Fine Amount (INR)
}
...
export interface Employee {
  ...
  fineSettings?: EmployeeFineSettings; // Employee-specific overrides
  department?: string; // For reporting filters
}
...
export interface Deduction {
  ...
  // New optional properties for auto-generated attendance fines
  isAutoGenerated?: boolean;
  workedHours?: number;
  standardHours?: number;
  missingHours?: number;
  fineAmount?: number; // original fine amount before waive/change
  createdDate?: string;
  status?: 'Active' | 'Waived' | 'Deleted';
...
export interface AttendanceReview {
  ...
  autoDeductionOn: boolean;
  deductionId?: string; // Link to created Deduction
  rejectionReason?: string;
  actionBy?: string;
  actionDate?: string;
}
...
export interface CompanySettings {
  ...
  // Attendance Fine Company Defaults
  attendanceFineEnabled?: boolean;
  autoDeductionEnabled?: boolean;
  gracePeriodDays?: number;
  maxFineAmount?: number;
  fiftyPercentRuleEnabled?: boolean;
  companyFineTable?: Record<number, number>; // Missing Hours (integer) -> Fine Amount (INR)
}
